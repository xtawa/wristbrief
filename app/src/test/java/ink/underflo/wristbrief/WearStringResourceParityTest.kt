...
class WearStringResourceParityTest {

    @Test
    fun englishAndChineseWearStringKeysMatchExactly() {
        val enFile = resolveFile("src/main/res/values/strings.xml", "app/src/main/res/values/strings.xml")
        val zhFile = resolveFile("src/main/res/values-zh-rCN/strings.xml", "app/src/main/res/values-zh-rCN/strings.xml")
        ...
        assertEquals("Keys present in app values/strings.xml but missing in app values-zh-rCN/strings.xml: $missingInZh", emptySet<String>(), missingInZh)
        assertEquals("Keys present in app values-zh-rCN/strings.xml but missing in app values/strings.xml: $missingInEn", emptySet<String>(), missingInEn)
    }
